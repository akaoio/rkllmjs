  ...
  describe('RKLLMParam interface', () => {
    it('should accept valid main parameters', () => {
      ...
      try {
        ...
        testLogger.info('RKLLMParam validation completed with real model', {
          modelPath: realModelPath,
        });
      } catch (error) {
  ...
  describe('Utility types', () => {
    it('should accept DefaultParamOptions', () => {
      ...
      try {
        ...
        testLogger.info('DefaultParamOptions validation completed with real model', {
          modelPath: realModelPath,
        });
      } catch (error) {
        if (error instanceof Error && error.message.includes('Test model not found')) {
