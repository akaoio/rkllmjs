/**
 * N-API implementation wrapper for RKLLM
 * This wraps the existing N-API implementation to match the backend interface
 */
...
/**
 * N-API based RKLLM implementation
 * This is a wrapper around the existing native addon
 */
export class RKLLMNAPIImpl {
